  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Sign Up Form Container - Blur Transparent */}
        <div style={{
          flex: 1,
          display: 'flex',
          flexDirection: 'column',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div
                ...
                style={{
                  ...
                  height: 18.48,
                  padding: '1.44px',
                  background: acceptTerms ? '#0075FF' : '#4B5563',
                  borderRadius: 97.74,
                  display: 'flex',
                  alignItems: 'center',
                  cursor: 'pointer',
                  transition: 'all 0.3s ease',
                  justifyContent: acceptTerms ? 'flex-end' : 'flex-start'
                }}
              >
                <div style={{
                  width: 13.5,
            ...
            <div style={{
              ...
              <span style={{ color: '#A0AEC0', fontSize: 'clamp(12px, 1.2vw, 14px)', fontWeight: 400 }}>
                Already have an account?{' '}
              </span>
              <span 
                onClick={() => navigate('/signin')}
